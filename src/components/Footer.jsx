...
const Footer = () => {
  ...
  return (
    <div className="flex flex-col rounded-t-2xl md:flex-row md:justify-between bg-sky px-4 sm:px-6 md:px-12 py-8 md:py-10 text-white gap-10 md:gap-6 items-start md:items-stretch">
      ...
      <div className="w-full md:w-1/4 flex flex-col mt-[10px] items-center md:items-start text-center md:text-left gap-4">
        <div className=" pt-10 p-4 rounded-xl">
          ...
          />
          <br />
      <p style={{ textAlign: "center", marginLeft: "-10px" }} className="text-sm sm:text-base text-white italic">
   “Advancing Millets for a Regenerative Future”
      ...
      <div className="w-full md:w-1/4 flex flex-col items-center md:items-start text-center md:text-left">
        <h2 className="text-lightGreen font-semibold text-2xl sm:text-3xl border-b border-accent w-full pb-1">
          Quick Links
        </h2>
